 ...
 *
 * This utility wraps a promise factory function and returns a function that can be called within
 ...
 * @param promiseFactory - A function that returns the promise to convert into a Suspense resource
 ...
 * ```
 */
export const suspensify = <T>(promiseFactory: () => Promise<T>) => {
